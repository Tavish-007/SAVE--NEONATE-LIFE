...
if(isset($_POST['save']))
{
    ...
    {
        $search = $_POST['search'];
        $stmt = $con->prepare("select * from hspdet where hsp_loc like '%$search%' or hsp_name like '%$search%'");
        $stmt->execute();
...
<div class="container">
    <h3><u>Hospital Details</u></h3>
    <br/><br/>
    <form class="form-horizontal" action="#" method="post">
    <div class="row">
        <div class="form-group">
            <label class="control-label col-sm-4" for="email"><b>Search for kid Hospitals:</b>:</label>
            <div class="col-sm-4">
                ...
                <?php
                 if(!$employee_details)
                 {
                    ...
                    <tr>
                        ...
                        <td><?php echo $value['hsp_name'];?></td>
                        <td><?php echo $value['hsp_loc'];?></td>
                        <td><?php echo $value['hsp_em'];?></td>
                        <td><?php echo $value['hsp_cn'];?></td>

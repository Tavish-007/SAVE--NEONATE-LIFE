...
<html>
  ...
  <head>
    <title> Manager Login | Facile Food</title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Facile Food</a>
        </div>
    ...
    <div class="heading">
     ...
     <br>
     Manage all your restaurant from here.
    </div>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="myrestaurant.php" class="list-group-item active"><b>My Restaurant</b></a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;color:white"><b> MY RESTAURANT</b></h3>
